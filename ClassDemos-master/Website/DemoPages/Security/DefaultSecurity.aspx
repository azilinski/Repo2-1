<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="DefaultSecurity.aspx.cs" Inherits="DemoPages_Security_DefaultSecurity" %>
            ...
            <asp:ListView ID="UserListView" runat="server"
                ...
                <LayoutTemplate>
                    <table runat="server">
                        ...
                        <tr runat="server">
                            <td runat="server">
                                <asp:DataPager runat="server" ID="DataPagerRoles" PagedControlID="UserListVeiw" OnPreRender="DataPagerRoles_PreRender">
                                    <Fields>
            ...
            <asp:ListView ID="RoleListView" runat="server"
                ...
                <LayoutTemplate>
                    <table runat="server">
                        ...
                        <tr runat="server">
                            <td runat="server">
<%--                                Add the PagedControlID(pointers to ListView ID)
                                Add event OnPreRender="datapagerID_PreRender
                                Add in Code behhind the method for the event--%>
                                <asp:DataPager runat="server" ID="DataPagerUsers"
                                    PagedControlID="UserListVeiw" OnPreRender="DataPagerUser_PreRender">
                                    <Fields>
    ...
    <asp:ObjectDataSource runat="server" 
        ID="WaiterDataSource" OldValuesParameterFormatString="original_{0}" 
        SelectMethod="ListWaiters" TypeName="eRestaurantSystem.BLL.eRestaurantController"></asp:ObjectDataSource>
</asp:Content>
