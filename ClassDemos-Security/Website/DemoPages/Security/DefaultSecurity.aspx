    ...
    <div class="row">
        <div class="col-md-9">
                    ...
                    <table runat="server">
                        <tr>
                            <td>
                                ...
                                <asp:LinkButton runat="server" CommandName="AddWaiters" 
                                    Text="Add Waiters as users" ID="AddWaitersButton" />
                            </td>
                        </tr>
                    </table>
                </EmptyDataTemplate>
         ...
         <%--                   Add the PagedControlID (pointers to ListView ID)
                                ...
                                Add in code behind the method for the event--%>
                                <asp:DataPager runat="server" ID="DataPagerUsers"
                                    PagedControlID="UserListView"
            ...
            <asp:ListView ID="RoleListView" runat="server"
                ...
                <LayoutTemplate>
                    <table runat="server">
                        ...
                        <tr runat="server">
                            <td runat="server">
                                <asp:DataPager runat="server" ID="DataPagerRoles"
                                    PagedControlID="RoleListView"
