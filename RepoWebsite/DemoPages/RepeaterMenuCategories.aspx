...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
                    ...
                    <asp:Repeater ID="CategoryMenuItemList" runat="server"
                        ...
                        <ItemTemplate>
                            <h4>
                                ...
                                <span class="badge"><%# Eval("Calories") %> Cal</span>
                                <%# Eval("Comment") %>
                            </h4>
                        </ItemTemplate>
                    </asp:Repeater>
    ...
    <asp:ObjectDataSource ID="ODSMenuCategoryItems" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetCategoryMenuItems" TypeName="eResturauntSystem.BLL.eResturauntController"></asp:ObjectDataSource>
</asp:Content>
